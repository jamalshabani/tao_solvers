...
program_list = ["rm -rf test1", "rm -rf test2", "rm -rf test3",
                "python3 3_mat_least_square.py -tao_type bncg -tao_converged_reason -tao_monitor -tao_max_it 2000 -tao_ls_type more-thuente -m 'motion_mesh.msh' -o 'test3' -er 10.0 -es 1.0e-2 -vr 0.3 -vs 0.3 -k 5.0e-4 -e 4.0e-3 -p 2.0 -q 1.0"]
